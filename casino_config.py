...
tickets = '5286725316:AAGPL6Tfo_Q3JdLfB_rqjLRjfEpVa3wUCxQ' # TOKEN Бота воркера
bot = telebot.TeleBot('5222361352:AAEbUniyug37yzfV1qjKbe6osE5gxoXcass') # TOKEN Бота казино

admin = 896786689 # ID Админа
support_id = 896786689 # ID Саппорта
channel_id = -1001669733949 # ID Канала с вылатами
support = 'mrrakit' # Username Сапорта

phone = '79654240409' # Номер киви без +
token = 'ee014d9e0e4b4cf8c2c7964921f5cb40' # API TOKEN QIWI
