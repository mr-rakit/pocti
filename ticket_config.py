...
bot = telebot.TeleBot('5286725316:AAGPL6Tfo_Q3JdLfB_rqjLRjfEpVa3wUCxQ') # Токен бота воркеров

admin = 896786689 # ID Админа
support = 896786689 # ID сапорта
channel_id = -1001669733949 # ID Канала залётов
chat_worker_id = -1001704096937 # ID Чата с воркерами

bot_name = 'Callotrakitabot' # Username Бота

mater = '1.com' # Ссылка на мануалы
zalet = '1' # Ссылка на канал с залётами
infos = '1' # Ссылка на инфо канал
pname = '1' # Название проекта
pdate = '1.1.1' # Дата созданя проекта
